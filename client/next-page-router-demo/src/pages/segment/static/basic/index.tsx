...
export default function StaticBasic() {
  ...
  return (
    <div className={styles.common}>
      ...
      <br />
      static/basic 폴더의 index.tsx 파일을 열어주세요.
      <br />
      handleClickBasic 함수의 <span className={styles.yellow}>PROJECT_KEY</span>와 <span className={styles.yellow}>SEGMENT_KEY</span>를 콘솔에서 확인한 프로젝트 키와 세그먼트 키로 변경해주세요.
      <br />
      만약 실제 서비스에 적용하다가 타입 에러가 발생한다면 <span className={styles.yellow}>global.d.ts 파일을 참고</span>해주세요.
      <br />
      페이지 진입 후 nfStop를 함수가 실행되도록 하기 위해 static/basic/return 폴더의 index.tsx 파일을 열고, 아래 버튼을 눌러주세요.
      <br />
